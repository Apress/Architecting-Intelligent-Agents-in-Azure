...
from config.settings import AzureAgentConfig, MissingConfigError, load_config
...
BASE_INSTRUCTIONS = (
    ...
    "If the tool signals low confidence, choose the best fitting category yourself. "
...
async def run_thain_agent(
    ...
    memory_provider = MemoryContextProvider(memory_store)

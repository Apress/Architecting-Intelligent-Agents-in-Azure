...
This folder contains the original beta code matching the book listings. For the GA 1.5.0 version, use `Code GA/Chapter 4/thain`.
...
- An Azure OpenAI embeddings deployment, for example `text-embedding-3-small`

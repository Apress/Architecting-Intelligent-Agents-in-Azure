...
if semantic_search_config and AUTH_MODE == "managed_identity" and not semantic_search_config.embedding_api_key:
    ...
    if not embedding_key:
        raise MissingConfigError(
            ...
            "Set KEY_VAULT_URI and KV_EMBEDDING_API_KEY_NAME, or disable search."
        )
    semantic_search_config = dataclasses.replace(semantic_search_config, embedding_api_key=embedding_key)

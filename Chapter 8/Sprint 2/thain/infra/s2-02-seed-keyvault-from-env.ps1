...
$secretMap = @{
    "COSMOS_KEY" = "thain-cosmos-key"
    "AZURE_SEARCH_API_KEY" = "thain-search-api-key"
...
if ($ScrubEnv -and -not $seedFailures) {
    ...
    Set-Content -Path $EnvFile -Value ($keptLines + $overrideLines) -Encoding ascii

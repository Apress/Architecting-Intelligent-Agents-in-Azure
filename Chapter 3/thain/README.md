...
This folder contains the original beta code matching the book listings. For the GA 1.5.0 version, use `Code GA/Chapter 3/thain`.
...
- Retrieval currently returns the most recent complaints for the configured customer; Azure AI Search semantic recall is planned for the next iteration.
